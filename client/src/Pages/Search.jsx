...
const Search = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      urlParams.delete("category"); // Remove 'category' from the search params
    } else {
      urlParams.set("category", sidebarData.category); // Otherwise, set it
    }
